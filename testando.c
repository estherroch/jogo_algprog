...
// TENTATIVA DE FUNCAO PARA ABRIR OS OUTROS MAPAS

//dado um jogador, a partir de sua fase, define de que lvl ele tem q começar

/*void QualMapa(POSICAO *jogador){

    FILE *nivel;

    char nome_do_arquivo[TAMNOMEARQ] = {0};

    if(ferror(nivel)){
        printf("Aconteceu um erro na leitura\n");
    }

    //def de variaveis para rodar em loops
    int i;
    int j;

    //dada a fase indicada na struct do jogador, seleciona o mapa
    switch(p->fase){
        case 1:
            strcpy(nome_do_arquivo, "mapa1.txt");
            break;
        case 2:
            strcpy(nome_do_arquivo, "mapa2.txt");
            break;
        case 3:
            strcpy(nome_do_arquivo, "mapa3.txt");
            break;
        case 4:
            strcpy(nome_do_arquivo, "mapa4.txt");
            break;
        case 5:
            strcpy(nome_do_arquivo, "mapa5.txt");
            break;
    }

    //ABRE A O ARQUIVO CORRESPONDE A FASE ATUAL

    nivel = fopen(nome_do_arquivo, "r");

    if(nivel == NULL){
        printf("Nao foi possível abrir o arquivo.\n");
    }

    //gera uma matriz de caracteres baseado na leitura do arq do mapa
    for(i = 0; i < MAPA_COLUNA; i++) {
        for(j = 0; j < MAPA_LINHA; j++) {
...
{
    // LIMPA A POSICAO ANTERIOR DO JOGADOR
...
{
    // LIMPA A POSICAO ANTERIOR DO INIMIGO
...
//...........................................................................................................................//
    ...
    if (leMapa("mapa1.txt", &jogador, inimigos, &num_inimigos, mapa))
    {
        atualizarMapaGrafico(mapa, jogador); // ATUALIZA A REPRESENTAÇÃO GRÁFICA
    }


//...........................................................................................................................//
    MenuOptions currentOption = MENU_START;

    int enterPressed = 0;  // VARIAVEL PRA VERIFICAR SE A TECLA ENTER FOI PRESSIONADA
                    ...
                    if (GetTime() - lastMove > 0.1) // define velocidade jogador
                    {
                        ...
                        if (IsKeyDown(KEY_D))
                        {
                            ...
                            if (deveMover(&jogador, MAPA_LINHA, MAPA_COLUNA, mapa))
                            {
                                ...
                                {
                                    CloseWindow();    //chamaria a funcao qualMapa aqui
                                }
                                move(&jogador);
...
//...........................................................................................................................//
            ...
            if (currentOption == MENU_EXIT)
            {
                CloseWindow();  // FECHA A TELA DO JOGO
            }
            enterPressed = 0;
        }
    }// Fim do loop do menu
